export const profile = {
  ...
  nameHi: 'कृष्णबीर चौधरी',
  nameBn: 'শ্রী কৃষ্ণ বীর চৌধুরী',
  honorific: 'Shri',
  dob: '12 March 1951',
...
export const bks = {
  ...
  summary:
    'National farmer organisation led by Krishan Bir Chaudhary as President — advocating farmer rights, agricultural income, and just agri-policy in India and on global stages.',
  objectives: [
