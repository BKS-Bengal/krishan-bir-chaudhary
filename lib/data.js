...
export const seedBill2025 = {
  id: 'seed-bill-2025',
  kicker: 'Institutional engagement',
  title: 'Seed Bill 2025 · Krishi Bhavan',
  summary:
    'Participation in discussions on the Seed Bill 2025 at Krishi Bhavan with Union Agriculture Minister Shri Shivraj Singh Chouhan, including written suggestions submitted.',
  photos: [
    {
      src: '/photos/events/seed-bill-2025/document-exchange.jpg',
      alt: 'Krishan Bir Chaudhary with Union Agriculture Minister Shri Shivraj Singh Chouhan reviewing documents at Krishi Bhavan',
      caption:
        'With Union Agriculture Minister Shri Shivraj Singh Chouhan during Seed Bill 2025 discussions at Krishi Bhavan.',
    },
    {
      src: '/photos/events/seed-bill-2025/discussion-documents.jpg',
      alt: 'Krishan Bir Chaudhary in discussion with Shri Shivraj Singh Chouhan over Seed Bill documents',
      caption:
        'Discussing the Seed Bill 2025 with Union Agriculture Minister Shri Shivraj Singh Chouhan at Krishi Bhavan.',
    },
    {
      src: '/photos/events/seed-bill-2025/joint-review.jpg',
      alt: 'Krishan Bir Chaudhary and Shri Shivraj Singh Chouhan jointly reviewing papers at the Ministry',
      caption:
        'Joint review of documents with Union Agriculture Minister Shri Shivraj Singh Chouhan during the Seed Bill 2025 consultation.',
    },
    {
      src: '/photos/events/seed-bill-2025/delegation-meeting.jpg',
      alt: 'Delegation meeting on Seed Bill 2025 at the Ministry of Agriculture and Farmers Welfare',
      caption:
        'At Krishi Bhavan for Seed Bill 2025 discussions led by Union Agriculture Minister Shri Shivraj Singh Chouhan — written suggestions submitted.',
    },
  ],
};
...
export const mewatHaryana = {
  id: 'mewat-haryana',
  invitationId: 'mewat-invitation',
  title: 'Mewat Haryana',
  kicker: '5 September · Nuh (Mewat)',
  summary:
    'Samaj felicitation ceremony invitation for Dr. Irshad Mathepur in Nuh (Mewat), Haryana — Dr. Krishan Bir Chaudhary as Chief Guest.',
  video: {
    href: 'https://www.facebook.com/reel/1584945366367498',
    embedSrc:
      'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Freel%2F1584945366367498%2F&show_text=false&width=560',
    title: 'Mewat Haryana felicitation ceremony video',
  },
  invitation: {
    en: {
      org: 'Bharatiya Krishak Samaj (Annadata)',
      heading: 'Cordially Invites You',
      region: 'Bharatiya Krishak Samaj, District Nuh (Mewat), Haryana',
      body: 'All esteemed colleagues, intellectuals, and area residents are cordially invited to the Felicitation and Welcome Ceremony organized on the occasion of the nomination of Dr. Irshad Mathepur as District President by the Bharatiya Krishak Samaj, District Nuh (Mewat), Haryana.',
      date: '5 September',
      venue: 'Khedla Mod Panchayat Bhavan, Near Tikona Park, Nuh (Mewat), Haryana',
      chiefGuest: {
        name: 'Dr. Krishan Bir Chaudhary',
        lines: [
          'National President, BKS',
          'High-Powered Purchase Committee Member (MSP), Government of India',
        ],
      },
      specialGuests: [
        {
          name: 'Shri Gaurav Gautam',
          lines: ['Minister of State for Sports, Government of Haryana'],
        },
        {
          name: 'Ch. Zakir Hussain Ji',
          lines: [
            'Administrator, Waqf Board',
            'National Vice President, Minority Morcha, BJP',
          ],
        },
        {
          name: 'Shri Jan Mohammad Ji',
          lines: ['District Pramukh, Nuh (Mewat)'],
        },
      ],
      organizer: {
        name: 'Dr. Irshad Mathepur and the Entire Team',
        lines: ['Bharatiya Krishak Samaj, District Nuh (Mewat), Haryana'],
      },
      closing:
        'Your dignified presence will grace the occasion. Cordially invited and heartily welcome.',
    },
    hi: {
      org: 'भारतीय कृषक समाज (अन्नदाता)',
      heading: '।। हार्दिक निमंत्रण ।।',
      region: 'भारतीय कृषक समाज, जिला नूंह (मेवात) हरियाणा',
      body: 'भारतीय कृषक समाज, जिला नूंह (मेवात) हरियाणा द्वारा डॉ. इरशाद मठेपुर को जिला अध्यक्ष मनोनीत किए जाने के उपलक्ष्य में आयोजित सम्मान एवं स्वागत समारोह में आप सभी सम्मानित साथी, प्रबुद्धजन एवं क्षेत्रवासी सादर आमंत्रित हैं।',
      date: '5 सितम्बर',
      venue: 'खेड़ला मोड़ पंचायत भवन, निकट तिकोना पार्क, नूंह (मेवात) हरियाणा',
      chiefGuest: {
        name: 'डॉ. कृष्ण बीर चौधरी',
        lines: [
          'राष्ट्रीय अध्यक्ष, बी.के.एस.',
          'हाई पावर्ड परचेज कमेटी सदस्य (एम.एस.पी.), भारत सरकार',
        ],
      },
      specialGuests: [
        {
          name: 'श्री गौरव गौतम',
          lines: ['खेल राज्य मंत्री, हरियाणा सरकार'],
        },
        {
          name: 'चौ. ज़ाकिर हुसैन जी',
          lines: ['प्रशासक, वक्फ बोर्ड', 'राष्ट्रीय उपाध्यक्ष, अल्पसंख्यक मोर्चा, भाजपा'],
        },
        {
          name: 'श्री जान मोहम्मद जी',
          lines: ['जिला प्रमुख, नूंह (मेवात)'],
        },
      ],
      organizer: {
        name: 'डॉ. इरशाद मठेपुर एवं समस्त टीम',
        lines: ['भारतीय कृषक समाज, जिला नूंह (मेवात) हरियाणा'],
      },
      closing:
        'आपकी गरिमामयी उपस्थिति कार्यक्रम की शोभा बढ़ाएगी। विनीत एवं सादर आमंत्रित',
    },
  },
  invitationBanner: '/photos/events/mewat-haryana/invitation.jpg',
  photos: [
    {
      src: '/photos/events/mewat-haryana/welcome-garland.jpg',
      alt: 'Dr. Krishan Bir Chaudhary welcomed with marigold garland',
      caption: 'Chief Guest welcome with floral tributes',
    },
    {
      src: '/photos/events/mewat-haryana/felicitation-pagri.jpg',
      alt: 'Felicitation with traditional pagri and bouquet',
      caption: 'Pagri & bouquet felicitation',
    },
    {
      src: '/photos/events/mewat-haryana/outdoor-welcome.jpg',
      alt: 'Outdoor welcome group with marigold garlands',
      caption: 'Outdoor welcome with the organising team',
    },
    {
      src: '/photos/events/mewat-haryana/stage-dignitaries.jpg',
      alt: 'Dignitaries seated on stage at Nuh Panchayat Bhavan',
      caption: 'Stage — Bharatiya Krishak Samaj, District Nuh',
    },
    {
      src: '/photos/events/mewat-haryana/stage-awards.jpg',
      alt: 'Dignitaries with award plaques and garlands on stage',
      caption: 'Awards and felicitation on the dais',
    },
    {
      src: '/photos/events/mewat-haryana/hall-audience.jpg',
      alt: 'Audience gathered at the Nuh felicitation ceremony',
      caption: 'Gathering at Khedla Mod Panchayat Bhavan',
    },
  ],
};
